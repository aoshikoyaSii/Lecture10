...
public class EnvironmentProperty {
    ...
    public static EnvironmentProperty getInstance() { //singleton method;
        return EnvironmentProperty.EnvironmentPropertySingleton.INSTANCE; // returns only one environment
    }
